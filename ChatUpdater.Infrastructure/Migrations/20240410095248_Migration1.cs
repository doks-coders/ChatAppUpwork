    ...
    public partial class Migration1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    AppGroupId = table.Column<Guid>(type: "uuid", nullable: false),
                    AppUserId = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_GroupContacts_AspNetUsers_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_GroupContacts_GroupChats_AppGroupId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GroupContacts_AppGroupId",
                table: "GroupContacts",
                column: "AppGroupId");

            migrationBuilder.CreateIndex(
                name: "IX_GroupContacts_AppUserId",
                table: "GroupContacts",
                column: "AppUserId");
